...
module ComYanadoPublicApi
  ...
  class Task
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'highPriority')
        self.high_priority = attributes[:'highPriority']
      end
    ...
    def hash
      [assignee_id, assignee_name, create_time, description, due_date, high_priority, list_id, list_name, name, status_id, status_name, task_id].hash
    end
