...
module ComYanadoPublicApi
  ...
  class Comment
    ...
    def hash
      [assignee_id, assignee_name, created, id, list_id, list_name, message, status_id, status_name, task_created, task_description, task_due_date, task_high_priority, task_id, task_name, user_id, user_name].hash
    end
