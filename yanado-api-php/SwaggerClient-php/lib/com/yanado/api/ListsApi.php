...
class ListsApi
{
     ...
     * @return \com.yanado.invoker\com.yanado.model\ModelList[]
     */
     ...
     *
     * @throws \com.yanado.invoker\ApiException on non-2xx response
     * @return array of \com.yanado.invoker\com.yanado.model\ModelList[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getListsWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/public-api/lists";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\com.yanado.invoker\com.yanado.model\ModelList[]',
                '/public-api/lists'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\com.yanado.invoker\com.yanado.model\ModelList[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\com.yanado.invoker\com.yanado.model\ModelList[]', $e->getResponseHeaders());
